...
public class ClientMenuServiceImpl implements ClientMenuService {
    ...
    @Override
    public void seeClothes(Customer customer) {
        clientSeeClothesMenu.seeClothesMenu(customer);
    }
    ...
    @Override
    public void filterClothes(Customer customer) {

    }

    @Override
    public void clientOrderHistory(Customer customer) {
    ...
    @Override
    public void fillBalance(Customer customer) {
