...
import static uz.pdp.utils.Util.RED;
...
public class ClientMyCartServiceImpl implements ClientMyCartService {
    ...
    @Override
    public void clientMyCartMenu(Customer customer) {
    ...
    @Override
    public void showClothesInCart(Customer customer) {
    ...
    @Override
    public void addMore(Customer customer) {
        seeClothesMenu.seeClothesMenu(customer);
    }

    @Override
    public void removeItemFromCart(Customer customer) {
    ...
    @Override
    public void clientCheckOut(Customer customer) {
        if (customer.getMyCart().size() == 0){
            System.out.println("Cart is empty!!!");
            return;
        }
    ...
    public void downloadPdf_check(Customer customer, PayType selectedPayType) {
